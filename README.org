...
- [[#usage][Usage]]
  - [[#a-note-on-the-experimental-commands-vy-list-competency-and-vy-suggest][A note on the experimental commands: =vy-list-competency= and =vy-suggest=]]
- [[#demo][Demo]]
